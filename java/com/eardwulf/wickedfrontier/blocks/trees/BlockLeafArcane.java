...
public class BlockLeafArcane extends BlockLeaves implements IHasModel

{
    ...
    public BlockLeafArcane(String name, Material material, float light)
...

    {
...

        {
            ...
            spawnAsEntity(worldIn, pos, new ItemStack(ModItems.MAGIC_DUST));
...

    {
        ...
        return Item.getItemFromBlock(ModBlocks.SAPLING_ARCANE);
