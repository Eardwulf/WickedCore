 ...
 * 
 */
package com.eardwulf.wickedfrontier.blocks.tileentity;
 ...
 *
 */
public class TileEntityArcaneChest extends TileEntityLockableLoot implements ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.arcane_chest";
	}
	...
	{
		return new ContainerArcaneChest(playerInventory, this, playerIn);
	}

	@Override
	public String getGuiID() 
	{
		return Reference.MOD_ID + ":arcane_chest";
	}
	...
	public void update()
	{
		if (!this.world.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceSync + pos.getX() + pos.getY() + pos.getZ()) % 200 == 0)
        {
            ...
            {
                if (entityplayer.openContainer instanceof ContainerArcaneChest)
                {
                    if (((ContainerArcaneChest)entityplayer.openContainer).getChestInventory() == this)
                    {
