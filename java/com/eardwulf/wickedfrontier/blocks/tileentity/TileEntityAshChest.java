 ...
 *
 */
public class TileEntityAshChest extends TileEntityLockableLoot implements ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.ash_chest";
	}
	...
	{
		return new ContainerAshChest(playerInventory, this, playerIn);
	}

	@Override
	public String getGuiID() 
	{
		return Reference.MOD_ID + ":ash_chest";
	}
	...
	public void update()
	{
		if (!this.world.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceSync + pos.getX() + pos.getY() + pos.getZ()) % 200 == 0)
        {
            ...
            {
                if (entityplayer.openContainer instanceof ContainerAshChest)
                {
                    if (((ContainerAshChest)entityplayer.openContainer).getChestInventory() == this)
                    {
