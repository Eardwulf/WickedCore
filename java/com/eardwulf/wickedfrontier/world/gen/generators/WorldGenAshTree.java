 ...
 *
 */
public class WorldGenAshTree extends WorldGenAbstractTree

{

    private IBlockState blockStateWood = ModBlocks.LOG_ASH.getDefaultState();

    private IBlockState blockStateLeaves = ModBlocks.LEAVES_ASH.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
    ...
    public WorldGenAshTree(boolean parShouldNotify)
