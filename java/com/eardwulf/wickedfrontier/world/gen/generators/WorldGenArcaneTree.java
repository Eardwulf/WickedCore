 ...
 * 
 */
package com.eardwulf.wickedfrontier.world.gen.generators;
 ...
 *
 */
public class WorldGenArcaneTree extends WorldGenAbstractTree

{

    private IBlockState blockStateWood = ModBlocks.LOG_ARCANE.getDefaultState();

    private IBlockState blockStateLeaves = ModBlocks.LEAVES_ARCANE.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
    ...
    public WorldGenArcaneTree(boolean parShouldNotify)
...

    {
        ...
        int minHeight = parRandom.nextInt(6) + minTreeHeight;
